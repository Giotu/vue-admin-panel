    ...
    <div style="display: flex; gap: 1rem; margin: 1rem; align-items: center; flex-wrap: wrap">
      ...
      <UTabs :tabs="tabs" :selected-tab="selectedTab" @update-tab="selectedTab = $event">
        <div v-if="selectedTab === 'tab1'">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis voluptates ab ad omnis
          velit molestias. Distinctio possimus et nisi ex?
        </div>
      ...
      <span>
        ...
        dolor sit amet consectetur adipisicing elit. At, nulla. Sed illum similique vitae
        asperiores!
      </span>
